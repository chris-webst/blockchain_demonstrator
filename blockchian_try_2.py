...
class Blockchain:
    ...
    def genesis(self):
        ...
        genesis_block.hash = genesis_block.count_proof(self.difficulty)
        if genesis_block.valid_proof(genesis_block.hash, self.difficulty):
...
def index():
    if "user" in session:
        ...
        return render_template("index.html", usr = "5003")
    else:
        return redirect("/")
